...
public class PAMSApp {
    ...
    public static void main(String[] args) {
        ...
        List<Patient> patients = Arrays.asList(patientsArray);

        // Sort by Age descending (Oldest first, Youngest last)
        ...
        try {
            String jsonOutput = mapper.writeValueAsString(patients);
            System.out.println("Patients Data (Sorted by Age Descending):");
